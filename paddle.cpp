...
//=============================================================================
void Paddle::update(float frameTime, State state, Direction direction)
{
	...
	if (state == CROUCHING)
	{
		edge.top = (-paddleNS::HEIGHT / 2) / 3;             // set collision edges for crouching mario
	}
	else
	{
		edge.top = -paddleNS::HEIGHT / 2;             // reset collision edges
	}
}
